...
// Crew class with constructor with test values
class CrewMember { // Class names in OOP should always start with a capitalize
...
//First ship called with all test values added
const mav = new Ship ('Mars Ascent Vehicle', 'MAV', 'Ascend into low orbit');
console.log(mav)

//Second ship called with all test values added
